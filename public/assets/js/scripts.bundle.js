	...
	$.fn[pluginName].defaults = {
		...
		translate: {
			records: {
				...
				noRecords: '<span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/home/keenthemes/www/metronic/themes/metronic/theme/html/demo1/dist/../src/media/svg/icons/General/Sad.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
        ...
        </svg><!--end::Svg Icon--></span><br><br>No requests found. <br><br><a href="#" class="btn btn-primary">Send Payment Request</a>',
			},
			toolbar: {
				pagination: {
					items: {
